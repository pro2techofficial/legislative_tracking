...
if(isset($_POST['save'])){
    ...
    mysqli_query($conn,"INSERT INTO ordinances(ordinance_no,title,author,committee,date_filed,status,file_path,remarks) VALUES('$no','$title','$author','$committee','$date_filed','$status','$file','$remarks')");
    ...
    log_action($conn,"Added ordinance $no","Ordinance");
    header("Location: index.php"); exit();
}
?>
<div class="topbar"><div><h1>Add Ordinance</h1><p class="subtitle">Encode new legislative record.</p></div><a href="index.php" class="btn gray">Back</a></div>
<div class="panel">
<form method="POST" enctype="multipart/form-data" class="form-grid">
  <div><label>Ordinance Number</label><input name="no" required></div>
  ...
  <div class="form-full"><button class="btn" name="save">Save Ordinance</button></div>
</form>
</div>
